...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MultiWalletCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MultiWalletCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("MultiWalletCoin-start");
